...
The different $e_{ic}$'s of a given item $i$ and context $C'$ are added to the item to signify its popularity in the given context. \todo{Does that actually what the addition does tho?}
