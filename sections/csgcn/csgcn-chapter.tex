...
Additionally, we add the identity matrix $I$ to the last quadrant so that for each convolution, the context embeddings are only propagated with information about themselves.
