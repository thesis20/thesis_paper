...
Even though the intuition changes, the model architecture is the almost the same as defined in \Cref{subsec:csgcn_is_model_architecture}.
The difference is that the input to the convolution layers now includes the context nodes, which is used for the neighborhood aggregations.
