...
It is worth noting that unlike traditional GCNs, CSGCN does not utilize self-connections for, since the layer combination performed after the convolution layers captures the same effect as self-connections through the 0th layer.
\\\\
