...
This means that when neigbor nodes' representations are being propagated, the normalizaton is done with both the number of neighbors for the central node and the number of neighbors for the neighbor node which reprentation is being propagated.
\\\\
