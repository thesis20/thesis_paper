...
This approach is inspired by a combination of the random walk Laplacian $D^{-1}$ and the symmetrical normalized Laplacian $D^{-\frac{1}{2}}AD^{-\frac{1}{2}}$ used in CSGCN-IS.
...
\begin{figure}
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Effect of various normalizations on the YelpNC dataset for HR@20.}
