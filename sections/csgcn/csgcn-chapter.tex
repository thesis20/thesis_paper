...
This means that the model consists of three parts:
\begin{enumerate}
...
Even though the intuition changes, the model architecture is the same as defined in \Cref{subsec:csgcn_is_model_architecture}.
...
While this graph only shows the results for NDCG@20 on the YelpNC dataset, the trend is consistent across datasets and metrics.
