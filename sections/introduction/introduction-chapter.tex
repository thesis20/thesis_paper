...
In \Cref{sec:csgcn_is,sec:csgcn_adj} we propose two models, CSGCN-IS and CSGCN-ADJ, as possible solutions to utilizing context and side-information in a GCN-based model.
