...
This step can be repeated multiple times to gain higher-order connectivity, meaning that information is passed from neighbor nodes further away from the central node \cite{SimplifyingGCN, KOrderConnectivity}.
