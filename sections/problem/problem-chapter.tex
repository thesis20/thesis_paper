...
Data used for RS can be classified as either implicit or explicit.
...
\end{figure}
\cref{fig:bipartite-graph} consists of two distinct sets of nodes: Users ($U$) and items ($I$), and a set of edges ($E$) that connect the user and item if they have interacted with each other.
