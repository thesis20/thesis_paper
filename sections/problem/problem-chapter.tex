...
A common approach to integrating side-information into a recommendation model is to model a vector representation for it alongside the user and item vector representations.
