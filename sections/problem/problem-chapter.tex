...
The graph seen in \Cref{fig:bipartite-graph} can be extenden to also include nodes that represent side-information, which would be connected to the user and item nodes.
