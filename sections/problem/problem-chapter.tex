...
Feature propagation averages representations in the neighborhood of a node, such that the representation of each node becomes a sum of its neighbors features.
