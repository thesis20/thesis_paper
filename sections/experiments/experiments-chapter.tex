...
\begin{figure}
    ...
    \label{fig:ablation_study_context_specific_1}
\end{figure}
asdasdsa
\begin{figure}
    \begin{tikzpicture}
    ...
    \label{fig:ablation_study_context_specific_2}
\end{figure}

\Cref{fig:ablation_study_context_specific_1} shows the HR@20 for CSGCN-ADJ on YelpNC with different input. 
...
\\\\
\Cref{fig:ablation_study_context_specific_2} shows HR@20 for CSGCN-IS on YelpNC with different input.
...
The result of this, is that context can have different effect on the various items, resulting in more accurate context-specific recommendations.
