...
This is the case for context such as a timestamp, as at it can provide too much detail for an interaction for the model to be able to learn anything valueable from.
...
For timestamps, the problem would occur if each second or minute is modelled differently.
Therefore we discretize context that can have too many different values to avoid sparsity problems.
