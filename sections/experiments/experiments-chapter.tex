...
This is the case for context such as a timestamp, as the information about the interaction is too specific for the model to be able to learn anything valuable from it.
