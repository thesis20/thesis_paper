...
From this, we can assume that the CSGCN-IS and CSGCN-ADJ methods work best on fairly balanced datasets, whereas factorization machines seem to have an advantage on datasets with highly popular items.\\\\1
...
Due to the sheer amount of time required to fine-tune the hyperparameters, it has simply been run once with the settings presented in the original paper.
