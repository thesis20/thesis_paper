...
\todo{Ved ikke om det jeg har sat ind hører til RQ3 - Var det tænkt at det skulle besvares med en ablation study på context-specific recommendations?}
...
For this first ablation study, we run our proposed method, CSGCN-ADJ, where we use different inputs for the datasets YelpNC and ML1M, and measure the performances with NDCG@20.
...
\begin{figure}
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{The performance on NDCG@20 of our model with different types of input}
...
To conclude from the study on the YelpNC dataset, the usage of context is not able to provide better recommendations.
...
To answer RQ3, using side-information on top of context achieves the same results as just using context, suggesting that side-information does not improve context-aware recommendations for our model.