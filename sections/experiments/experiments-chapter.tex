...
Since most of the datasets mainly includes a timestamp as contextual variables, we discretize these into the following features:
\begin{itemize}
	\item Month
	\item Day of week
	\item Hour
...
Where time of day is a further discretization of the hour feature, split into 5 intervals for respectively:
\begin{itemize}
	\item Night (0 to 4)
	\item Morning (4 to 8)
...
\\\\
For the side-information, we use all the available side-info for both users and items with some discretization.
